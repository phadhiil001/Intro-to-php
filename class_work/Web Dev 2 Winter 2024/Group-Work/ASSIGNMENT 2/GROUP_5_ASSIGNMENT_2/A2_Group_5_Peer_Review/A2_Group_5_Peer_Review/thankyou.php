        ...
        ?>
            <div class="bold">
                ...
                if ($totalCost >= 20000) 
                {
                    ...
                    echo '<h2>Thank you for your large purchase of our product! Here is an Epic Sax Guy for you in celebration!</h2>';
                    echo '<iframe width="600" height="475" src="https://www.youtube.com/embed/oVcQTECY_ZQ?si=VREMuP74PF2UhSLb"></iframe>';
                    echo '</div>';
                }
                ?>
            </div>
